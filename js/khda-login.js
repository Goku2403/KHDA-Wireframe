...
(function () {
  ...
  $('#main').innerHTML = `<div class="klogin">
    <section class="klogin__card" aria-labelledby="loginTitle">
      <div class="klogin__eyebrow"><span><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 21h18M5 21V7l7-4 7 4v14M9 21v-6h6v6"/></svg></span>e-portal · KHDA Digital Platform</div>
      <h1 class="klogin__title" id="loginTitle">Welcome to <b>KHDA Higher-Education Data Portal</b></h1>
      <p class="klogin__text">Your institution's data, in one place. Sign in to manage submissions, fix issues and track readiness.</p>
      ...
      <button class="klogin__btn" type="button" id="btnPass" disabled>
      ...
      <div class="klogin__divider">For KHDA employees</div>
      <button class="klogin__btn" type="button" id="btnAd">
    ...
    <aside class="klogin__side" aria-label="Sector readiness">
